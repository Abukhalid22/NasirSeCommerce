...
namespace NasirsClothing.user
{
    public partial class payment_gateway : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            Response.Write("<input type='hidden' name='business' value='sb-c2ccp2397611@business.example.com'>");
            ...
            Response.Write("<input type='hidden' name='return' value='http://localhost:64048/user/payment_success.aspx?order=" + order_no.ToString() + "'>");
            Response.Write("</form>");
