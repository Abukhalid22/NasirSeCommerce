<%@ Page Title="" Language="C#" MasterPageFile="~/user/user.Master" AutoEventWireup="true" CodeBehind="view_full_order.aspx.cs" Inherits="NasirsClothing.user.view_full_order" %>
